...
7. **"Turn it off" / "disable"** → `~/.cursor/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.cursor/skills/gstack/bin/gstack-config set question_tuning true`
