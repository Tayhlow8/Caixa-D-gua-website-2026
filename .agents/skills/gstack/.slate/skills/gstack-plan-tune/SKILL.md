...
7. **"Turn it off" / "disable"** → `~/.slate/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.slate/skills/gstack/bin/gstack-config set question_tuning true`
