...
7. **"Turn it off" / "disable"** → `~/.kiro/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.kiro/skills/gstack/bin/gstack-config set question_tuning true`
