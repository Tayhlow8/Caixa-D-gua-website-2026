...
7. **"Turn it off" / "disable"** → `~/.openclaw/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.openclaw/skills/gstack/bin/gstack-config set question_tuning true`
