...
7. **"Turn it off" / "disable"** → `~/.gbrain/skills/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.gbrain/skills/gstack/bin/gstack-config set question_tuning true`
